...
class SVDK_Nov17: public IPredictor{
    private:
        ...
        vector < vector <double> > userSVD;
        vector < vector <double> > movieSVD;
    ...
    public:
        ...
        static const int LEARN_EPOCHS_MIN = 1; //Papers suggest a big dip in RMSE if >50?
        static const int REFINE_EPOCHS_MIN = 1; //Feasible time-wise

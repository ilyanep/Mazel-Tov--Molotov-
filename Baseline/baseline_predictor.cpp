...
void Baseline::calculate_user_time_spikes(int partition){
 ...
 */
void Baseline::find_user_rating_days(int partition){
...
int Baseline::findMinIndex(gsl_matrix *mat, int numPts){
    int minIndex = 0;
    int minValue = 99999;
    int value = 0;
...
/*
void Baseline::refine_by_gradient_descent(int partition){
...
/*
double Baseline::rmse_probe_part(int partition){
    double RMSE = 0.0;
    int count = 0;
...
*/
/*
double Baseline::rmse_probe_user(int partition, int user, int startIndex, int endIndex){
    double RMSE = 0.0;
    int count = 0;
    int ptUser;
...
*/
/*
double Baseline::rmse_probe_movie(int partition, int movie){
    double RMSE = 0.0;
    int count = 0;
    int ptMovie;
    for(int i = 0; i < DATA_COUNT; i++) {
 ...
 */
void Baseline::calculate_user_time_gradient(int partition){
    int user;
    int movie;
    int binNumber;
    double date;
